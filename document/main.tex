...
\end{table}
TODO: Fix search string for MLR and yield result!
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|c|c|}
        ...
        ID & Filter \\
        \hline
        1 & Must be relevant for te study research \\
        \hline
        2 & English \\
        \hline
    \end{tabular}
