...
\hspace*{\linewidth}\par
\noindent\textbf{RQ.3}: Which requirement-related factors most commonly lead to technical debt, and how are they identified and mitigated in practice?\par
\hspace*{\linewidth}\par
\noindent\textbf{RQ.4}: 
What RE process is most commonly linked to technical debt, and how can they improve to mitigate technical debt?\par
\hspace*{\linewidth}\par
\noindent\textbf{RQ.5}: 
...
\noindent Starting from this study's research question, the necessary keywords to perform the research were extracted in order to generate an insightful search string, as shown in \tabref{tab:keywords_and_search_string}.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|>{\columncolor{gray!30}}c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Keywords and Search string}
    \label{tab:keywords_and_search_string}
\end{table}
...
\hspace*{\linewidth}\par
\noindent\textbf{RQ.3}: Which requirement-related factors most commonly lead to technical debt, and how are they identified and mitigated in practice?
...
\hspace*{\linewidth}\par
\noindent\textbf{RQ.4}: 
TODO: What RE process is most commonly linked to technical debt, and how can they improve to mitigate technical debt?\par

\hspace*{\linewidth}\par
\noindent\textbf{RQ.5}: 
TODO:How do different project contexts and team structures affect the emergence or management of RTD?\par
