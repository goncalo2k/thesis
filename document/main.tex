...
\parencite{Femmer2019, Behutiye2020}. Rather 
...
\gls{br}, from \gls{sr} \parencite{Behutiye2020, Melo2022}. The second dimension differentiates between \gls{fr} and 
...
while acknowledging that both may originate at either the business or system level \parencite{Behutiye2020}. This 
...
sustains value over time. Commonly cited quality attributes include performance, reliability, security, maintainability, usability, 
...
Unlike \gls{fr}, which define discrete system capabilities, quality attributes are inherently cross-cutting and often 
span multiple system components and development activities. As a result, they are more difficult to specify, validate, 
and prioritize, particularly in AGILE and iterative development contexts \parencite{Behutiye2020}. When quality 
...
For this reason, quality attributes play a central role in this study’s analysis of requirement quality. Their treatment 
